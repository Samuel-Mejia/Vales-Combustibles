...
<body class="bg-[#30475e]">
    ...
    <!-- Modal 1 -->
    <dialog id="my_modal_1" data-modal-backdrop="static" tabindex="-1" aria-hidden="true" class="hidden fixed top-0 right-0 left-0 z-50 w-full h-full bg-black bg-opacity-50  justify-center items-center p-4" x-data="{ activeView: 'ingresoVales' }" @click.outside="openModal = false">
