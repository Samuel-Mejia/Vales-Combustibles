        ...
        <div class="grid gap-6 mb-6 grid-cols-1 md:grid-cols-3">
            <div>
                <label class="form-control w-full ">
                    ...
                    <textarea name="mision" class="textarea text-black bg-gray-50 border border-gray-300 input input-bordered w-full"
            ...
            <div>
                <label class="form-control w-full">
                    ...
                    <select name="departamento" class="bg-white text-black border-gray-300 select select-bordered w-full">
            ...
            <div>
                <label class="form-control w-full">
                    ...
                    <input type="date" name="fecha_reserva" class="bg-[#7b7f85] border-white text-white input input-bordered w-full" />
                </label>
            </div>
            <div>
                <label class="form-control w-full">
                    ...
                    <input type="date" name="fecha_vence" class="bg-[#7b7f85] border-white text-white input input-bordered w-full" />
                </label>
            </div>
            <div>
                <label class="form-control w-full">
